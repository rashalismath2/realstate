...
class NewAd extends Component {
    ...
    render() {
        ...
        const salesSubtypes = this.props.SalesItemsTypes[this.state.selectedSalesType].map(type => {
            return (
            ...
            <div className="NewAd-container">
                <form className="newAd-form" onSubmit={this.handleSubmit}>
                    ...
                    <Input
                        ...
                        name="contact"
                        onChange={this.handleInputChange}
                        className="mb-3 newAd-contact"
                        placeholder="Contact"
                        inputProps={{ "aria-label": "description" }}
                    />
                    <div className="formDropDowns mb-3">
                    ...
                    <Input
                        ...
                        name="price"
                        onChange={this.handleInputChange}
                        className="mb-3 newAd-price"
                        placeholder="Price"
                        inputProps={{ "aria-label": "description" }}
                    />

                    <div className="mb-3  newAd-files">
                        <input accept="image/*" className="newAd-file" multiple type="file" onChange={this.saveFile} />
                        <span>*Please upload only 4 images</span>
                    </div>

                    <button disabled={this.state.btnDisabled} type="submit">Submit</button>
...
const mapStateToProps = (state) => {
    ...
    return {
        ...
        SalesItemsTypes: state.SalesItemsReducer.SalesItems
    }
}
